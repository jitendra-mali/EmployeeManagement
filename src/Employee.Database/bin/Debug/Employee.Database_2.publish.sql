...
GO
PRINT N'Creating Foreign Key [dbo].[fk_Employee_Superviosr_EmployeeId_Manager]...';


GO
ALTER TABLE [dbo].[Supervisor]
    ADD CONSTRAINT [fk_Employee_Superviosr_EmployeeId_Manager] FOREIGN KEY ([ManagerId]) REFERENCES [dbo].[Manager] ([Id]);
